...
class Suglasnost(models.Model):
    ...
    odobren  = models.BooleanField("Odobren", null=True, 
        help_text="Označite dajete li suglasnost za prisustvo djeteta u predstavi. "
                  "Spremite neoznačeno ukoliko ne dajete suglasnost")
